...
func EncodeMsgp(obj msgp.Marshaler) ([]byte, error) {
	return obj.MarshalMsg(nil)
}

// Encode returns a msgpack-encoded byte buffer for a given object.
func Encode(obj msgp.Marshaler) ([]byte, error) {
	enc, err := EncodeMsgp(obj)
	if err != nil {
...
// take a look at /home/hmeneses/Projects/lixo/go-algorand/daemon/algod/api/client/restClient.go
// SendRawTransactionGroup
// use mspg_gen
func EncodeArray[T any](array []T) ([]byte, error) {
	res := make([]byte, 0)
...
func DecodeArray[T any](reader io.Reader) ([]T, error) {
	var items []T
